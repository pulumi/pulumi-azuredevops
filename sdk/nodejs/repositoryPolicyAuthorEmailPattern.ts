...
export class RepositoryPolicyAuthorEmailPattern extends pulumi.CustomResource {
     ...
     */
    declare public readonly authorEmailPatterns: pulumi.Output<string[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RepositoryPolicyAuthorEmailPatternArgs | RepositoryPolicyAuthorEmailPatternState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["authorEmailPatterns"] = state?.authorEmailPatterns;
            ...
            if (args?.authorEmailPatterns === undefined && !opts.urn) {
                throw new Error("Missing required property 'authorEmailPatterns'");
            }
            if (args?.projectId === undefined && !opts.urn) {
                throw new Error("Missing required property 'projectId'");
            }
            resourceInputs["authorEmailPatterns"] = args?.authorEmailPatterns;
...
export interface RepositoryPolicyAuthorEmailPatternState {
     ...
     * ~>**NOTE:** Email patterns prefixed with `!` are excluded. Order is important.
     */
    authorEmailPatterns?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * A flag indicating if the policy should be blocking. Defaults to `true`.
     */
