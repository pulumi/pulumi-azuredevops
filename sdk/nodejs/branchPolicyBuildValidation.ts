...
export class BranchPolicyBuildValidation extends pulumi.CustomResource {
     ...
     */
    declare public readonly settings: pulumi.Output<outputs.BranchPolicyBuildValidationSettings>;
...
export interface BranchPolicyBuildValidationState {
     ...
     * A `settings` block as defined below. Configuration for the policy. This block must be defined exactly once.
     */
    settings?: pulumi.Input<inputs.BranchPolicyBuildValidationSettings | undefined>;
}
