...
export class BranchPolicyCommentResolution extends pulumi.CustomResource {
     ...
     */
    declare public readonly settings: pulumi.Output<outputs.BranchPolicyCommentResolutionSettings>;
...
export interface BranchPolicyCommentResolutionState {
     ...
     * A `settings` block as defined below. Configuration for the policy. This block must be defined exactly once.
     */
    settings?: pulumi.Input<inputs.BranchPolicyCommentResolutionSettings | undefined>;
}
