 ...
 *     name: "Readers",
 * });
 * const root_permissions = new azuredevops.ServiceendpointPermissions("root-permissions", {
 *     projectId: project.id,
 ...
 * });
 * const serviceendpoint_permissions = new azuredevops.ServiceendpointPermissions("serviceendpoint-permissions", {
 *     projectId: project.id,
 *     principal: project_readers.apply(project_readers => project_readers.id),
