...
export class Kubernetes extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azuredevops:index/kubernetes:Kubernetes';
     ...
     */
    public readonly azureSubscriptions!: pulumi.Output<outputs.KubernetesAzureSubscription[] | undefined>;
    public readonly description!: pulumi.Output<string | undefined>;
    /**
     * The configuration for authorization_type="Kubeconfig".
     */
    public readonly kubeconfigs!: pulumi.Output<outputs.KubernetesKubeconfig[] | undefined>;
    /**
     ...
     */
    public readonly serviceAccounts!: pulumi.Output<outputs.KubernetesServiceAccount[] | undefined>;
    /**
...
export interface KubernetesState {
     ...
     * The configuration for authorization_type="AzureSubscription".
     */
    readonly azureSubscriptions?: pulumi.Input<pulumi.Input<inputs.KubernetesAzureSubscription>[]>;
    readonly description?: pulumi.Input<string>;
    /**
     * The configuration for authorization_type="Kubeconfig".
     */
    readonly kubeconfigs?: pulumi.Input<pulumi.Input<inputs.KubernetesKubeconfig>[]>;
    /**
     * The project ID or project name.
     */
     ...
     * The configuration for authorization_type="ServiceAccount". This type uses the credentials of a service account currently deployed to the cluster.
     */
    readonly serviceAccounts?: pulumi.Input<pulumi.Input<inputs.KubernetesServiceAccount>[]>;
    /**
     * The Service Endpoint name.
     */
