...
export class ServiceendpointArgocd extends pulumi.CustomResource {
     ...
     */
    declare public readonly authenticationBasic: pulumi.Output<outputs.ServiceendpointArgocdAuthenticationBasic | undefined>;
    /**
     * An `authenticationToken` block for the ArgoCD as documented below.
     */
    declare public readonly authenticationToken: pulumi.Output<outputs.ServiceendpointArgocdAuthenticationToken | undefined>;
