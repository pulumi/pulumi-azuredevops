...
export class BranchPolicyWorkItemLinking extends pulumi.CustomResource {
     ...
     */
    declare public readonly settings: pulumi.Output<outputs.BranchPolicyWorkItemLinkingSettings>;
...
export interface BranchPolicyWorkItemLinkingState {
     ...
     * A `settings` block as defined below. Configuration for the policy. This block must be defined exactly once.
     */
    settings?: pulumi.Input<inputs.BranchPolicyWorkItemLinkingSettings | undefined>;
}
