...
export class AzureRM extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azuredevops:index/azureRM:AzureRM';
     ...
     * A `credentials` block.
     */
    public readonly credentials!: pulumi.Output<outputs.AzureRMCredentials | undefined>;
...
export interface AzureRMState {
     ...
     * A `credentials` block.
     */
    readonly credentials?: pulumi.Input<inputs.AzureRMCredentials>;
