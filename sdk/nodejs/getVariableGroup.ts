 ...
 *
 * const testProject = azuredevops.getProject({
 *     name: "Test Project",
 * });
 * const testVariableGroup = testProject.then(testProject => azuredevops.getVariableGroup({
 *     projectId: testProject.id,
 *     name: "Sample Variable Group",
 * }));
 * export const id = testVariableGroup.then(testVariableGroup => testVariableGroup.id);
 * ```
 * ## Relevant Links
 *
