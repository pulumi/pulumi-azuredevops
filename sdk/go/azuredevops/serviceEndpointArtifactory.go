...
func (i *ServiceEndpointArtifactory) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointArtifactory] {
	return pulumix.Output[*ServiceEndpointArtifactory]{
		OutputState: i.ToServiceEndpointArtifactoryOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointArtifactoryArray) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointArtifactory] {
	return pulumix.Output[[]*ServiceEndpointArtifactory]{
		OutputState: i.ToServiceEndpointArtifactoryArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointArtifactoryMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointArtifactory] {
	return pulumix.Output[map[string]*ServiceEndpointArtifactory]{
		OutputState: i.ToServiceEndpointArtifactoryMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceEndpointArtifactoryOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointArtifactory] {
	return pulumix.Output[*ServiceEndpointArtifactory]{
...
func (o ServiceEndpointArtifactoryArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointArtifactory] {
	return pulumix.Output[[]*ServiceEndpointArtifactory]{
		OutputState: o.OutputState,
	}
}
...
func (o ServiceEndpointArtifactoryMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointArtifactory] {
	return pulumix.Output[map[string]*ServiceEndpointArtifactory]{
		OutputState: o.OutputState,
	}
}
