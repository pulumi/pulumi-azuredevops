...
func NewBitBucket(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azuredevops:index/bitBucket:BitBucket", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBitBucket(ctx *pulumi.Context,
	...
	var resource BitBucket
	err := ctx.ReadResource("azuredevops:index/bitBucket:BitBucket", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
