...
func (i *ServicehookPermissions) ToOutput(ctx context.Context) pulumix.Output[*ServicehookPermissions] {
	return pulumix.Output[*ServicehookPermissions]{
		OutputState: i.ToServicehookPermissionsOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServicehookPermissionsArray) ToOutput(ctx context.Context) pulumix.Output[[]*ServicehookPermissions] {
	return pulumix.Output[[]*ServicehookPermissions]{
		OutputState: i.ToServicehookPermissionsArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServicehookPermissionsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServicehookPermissions] {
	return pulumix.Output[map[string]*ServicehookPermissions]{
		OutputState: i.ToServicehookPermissionsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServicehookPermissionsOutput) ToOutput(ctx context.Context) pulumix.Output[*ServicehookPermissions] {
	return pulumix.Output[*ServicehookPermissions]{
...
func (o ServicehookPermissionsArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ServicehookPermissions] {
	return pulumix.Output[[]*ServicehookPermissions]{
		OutputState: o.OutputState,
	}
}
...
func (o ServicehookPermissionsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServicehookPermissions] {
	return pulumix.Output[map[string]*ServicehookPermissions]{
		OutputState: o.OutputState,
	}
}
