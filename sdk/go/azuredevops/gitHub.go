...
func NewGitHub(ctx *pulumi.Context,
	...
	var resource GitHub
	err := ctx.RegisterResource("azuredevops:index/gitHub:GitHub", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitHub(ctx *pulumi.Context,
	...
	var resource GitHub
	err := ctx.ReadResource("azuredevops:index/gitHub:GitHub", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
