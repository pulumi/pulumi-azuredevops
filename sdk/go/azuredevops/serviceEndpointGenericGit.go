...
func (i *ServiceEndpointGenericGit) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointGenericGit] {
	return pulumix.Output[*ServiceEndpointGenericGit]{
		OutputState: i.ToServiceEndpointGenericGitOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointGenericGitArray) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointGenericGit] {
	return pulumix.Output[[]*ServiceEndpointGenericGit]{
		OutputState: i.ToServiceEndpointGenericGitArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointGenericGitMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointGenericGit] {
	return pulumix.Output[map[string]*ServiceEndpointGenericGit]{
		OutputState: i.ToServiceEndpointGenericGitMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceEndpointGenericGitOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointGenericGit] {
	return pulumix.Output[*ServiceEndpointGenericGit]{
...
func (o ServiceEndpointGenericGitArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointGenericGit] {
	return pulumix.Output[[]*ServiceEndpointGenericGit]{
		OutputState: o.OutputState,
	}
}
...
func (o ServiceEndpointGenericGitMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointGenericGit] {
	return pulumix.Output[map[string]*ServiceEndpointGenericGit]{
		OutputState: o.OutputState,
	}
}
