...
func (i *ServiceEndpointAzureDevOps) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointAzureDevOps] {
	return pulumix.Output[*ServiceEndpointAzureDevOps]{
		OutputState: i.ToServiceEndpointAzureDevOpsOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointAzureDevOpsArray) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointAzureDevOps] {
	return pulumix.Output[[]*ServiceEndpointAzureDevOps]{
		OutputState: i.ToServiceEndpointAzureDevOpsArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ServiceEndpointAzureDevOpsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointAzureDevOps] {
	return pulumix.Output[map[string]*ServiceEndpointAzureDevOps]{
		OutputState: i.ToServiceEndpointAzureDevOpsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ServiceEndpointAzureDevOpsOutput) ToOutput(ctx context.Context) pulumix.Output[*ServiceEndpointAzureDevOps] {
	return pulumix.Output[*ServiceEndpointAzureDevOps]{
...
func (o ServiceEndpointAzureDevOpsArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ServiceEndpointAzureDevOps] {
	return pulumix.Output[[]*ServiceEndpointAzureDevOps]{
		OutputState: o.OutputState,
	}
}
...
func (o ServiceEndpointAzureDevOpsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ServiceEndpointAzureDevOps] {
	return pulumix.Output[map[string]*ServiceEndpointAzureDevOps]{
		OutputState: o.OutputState,
	}
}
