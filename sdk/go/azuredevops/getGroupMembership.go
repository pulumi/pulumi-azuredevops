...
//			_, err := azuredevops.GetGroupMembership(ctx, &azuredevops.LookupGroupMembershipArgs{
...
func LookupGroupMembershipOutput(ctx *pulumi.Context, args LookupGroupMembershipOutputArgs, opts ...pulumi.InvokeOption) LookupGroupMembershipResultOutput {
	...
	return ctx.InvokeOutput("azuredevops:index/getGroupMembership:getGroupMembership", args, LookupGroupMembershipResultOutput{}, options).(LookupGroupMembershipResultOutput)
}
