...
// An `authenticationToken` block for the ArgoCD as documented below.
func (o ServiceendpointArgocdOutput) AuthenticationToken() ServiceendpointArgocdAuthenticationTokenPtrOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) ServiceendpointArgocdAuthenticationTokenPtrOutput {
		return v.AuthenticationToken
	}).(ServiceendpointArgocdAuthenticationTokenPtrOutput)
}

func (o ServiceendpointArgocdOutput) Authorization() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) pulumi.StringMapOutput { return v.Authorization }).(pulumi.StringMapOutput)
}

// The Service Endpoint description.
func (o ServiceendpointArgocdOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}

// The ID of the project.
func (o ServiceendpointArgocdOutput) ProjectId() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) pulumi.StringOutput { return v.ProjectId }).(pulumi.StringOutput)
}

// The Service Endpoint name.
func (o ServiceendpointArgocdOutput) ServiceEndpointName() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) pulumi.StringOutput { return v.ServiceEndpointName }).(pulumi.StringOutput)
}

// URL of the ArgoCD server to connect with.
func (o ServiceendpointArgocdOutput) Url() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceendpointArgocd) pulumi.StringOutput { return v.Url }).(pulumi.StringOutput)
}
