...
func NewAzureRM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azuredevops:index/azureRM:AzureRM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAzureRM(ctx *pulumi.Context,
	...
	var resource AzureRM
	err := ctx.ReadResource("azuredevops:index/azureRM:AzureRM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
