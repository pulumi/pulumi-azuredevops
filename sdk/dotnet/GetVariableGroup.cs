...
namespace Pulumi.AzureDevOps
{
    public static class GetVariableGroup
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testProject = Output.Create(AzureDevOps.GetProject.InvokeAsync(new AzureDevOps.GetProjectArgs
        ///         {
        ///             Name = "Test Project",
        ///         }));
        ///         var testVariableGroup = testProject.Apply(testProject =&gt; Output.Create(AzureDevOps.GetVariableGroup.InvokeAsync(new AzureDevOps.GetVariableGroupArgs
        ///         {
        ///             ProjectId = testProject.Id,
        ///             Name = "Sample Variable Group",
        ///         })));
        ///         this.Id = testVariableGroup.Apply(testVariableGroup =&gt; testVariableGroup.Id);
        ///     }
        /// 
        ///     [Output("id")]
