...
namespace Pulumi.AzureDevOps.Security
{
    ...
    /// </summary>
    [Obsolete(@"azuredevops.security/resourceauthorization.ResourceAuthorization has been deprecated in favor of azuredevops.index/resourceauthorization.ResourceAuthorization")]
    ...
    public partial class ResourceAuthorization : global::Pulumi.CustomResource
    {
        ...
        public ResourceAuthorization(string name, ResourceAuthorizationArgs args, CustomResourceOptions? options = null)
            : base("azuredevops:Security/resourceAuthorization:ResourceAuthorization", name, args ?? new ResourceAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ResourceAuthorization(string name, Input<string> id, ResourceAuthorizationState? state = null, CustomResourceOptions? options = null)
            : base("azuredevops:Security/resourceAuthorization:ResourceAuthorization", name, state, MakeResourceOptions(options, id))
        {
        }
