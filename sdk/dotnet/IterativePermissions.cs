...
namespace Pulumi.AzureDevOps
{
    ...
    ///     });
    /// 
    ///     var example_root_permissions = new AzureDevOps.Index.IterativePermissions("example-root-permissions", new()
    ///     {
    ///         ProjectId = example.Id,
    ...
    ///     });
    /// 
    ///     var example_iteration_permissions = new AzureDevOps.Index.IterativePermissions("example-iteration-permissions", new()
    ///     {
    ///         ProjectId = example.Id,
    ///         Principal = example_readers.Apply(example_readers =&gt; example_readers.Apply(getGroupResult =&gt; getGroupResult.Id)),
    ///         Path = "Iteration 1",
