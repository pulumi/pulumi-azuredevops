...
namespace Pulumi.AzureDevOps
{
    ...
    public partial class DockerRegistry : Pulumi.CustomResource
    {
        ...
        public DockerRegistry(string name, DockerRegistryArgs args, CustomResourceOptions? options = null)
            : base("azuredevops:index/dockerRegistry:DockerRegistry", name, args ?? new DockerRegistryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DockerRegistry(string name, Input<string> id, DockerRegistryState? state = null, CustomResourceOptions? options = null)
            : base("azuredevops:index/dockerRegistry:DockerRegistry", name, state, MakeResourceOptions(options, id))
        {
        }
