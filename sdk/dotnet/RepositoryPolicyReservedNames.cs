...
namespace Pulumi.AzureDevOps
{
    ...
    public partial class RepositoryPolicyReservedNames : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RepositoryPolicyReservedNames(string name, RepositoryPolicyReservedNamesArgs args, CustomResourceOptions? options = null)
            : base("azuredevops:index/repositoryPolicyReservedNames:RepositoryPolicyReservedNames", name, args ?? new RepositoryPolicyReservedNamesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RepositoryPolicyReservedNames(string name, Input<string> id, RepositoryPolicyReservedNamesState? state = null, CustomResourceOptions? options = null)
            : base("azuredevops:index/repositoryPolicyReservedNames:RepositoryPolicyReservedNames", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RepositoryPolicyReservedNames Get(string name, Input<string> id, RepositoryPolicyReservedNamesState? state = null, CustomResourceOptions? options = null)
        {
            return new RepositoryPolicyReservedNames(name, id, state, options);
        }
    }

    public sealed class RepositoryPolicyReservedNamesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A flag indicating if the policy should be blocking. Defaults to `true`.
        /// </summary>
        ...
        public RepositoryPolicyReservedNamesArgs()
        {
        }
        public static new RepositoryPolicyReservedNamesArgs Empty => new RepositoryPolicyReservedNamesArgs();
    }

    public sealed class RepositoryPolicyReservedNamesState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A flag indicating if the policy should be blocking. Defaults to `true`.
        /// </summary>
        ...
        public RepositoryPolicyReservedNamesState()
        {
        }
        public static new RepositoryPolicyReservedNamesState Empty => new RepositoryPolicyReservedNamesState();
    }
}
