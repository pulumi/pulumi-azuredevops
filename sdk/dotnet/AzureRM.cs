...
namespace Pulumi.AzureDevOps
{
    ...
    public partial class AzureRM : Pulumi.CustomResource
    {
        ...
        public AzureRM(string name, AzureRMArgs args, CustomResourceOptions? options = null)
            : base("azuredevops:index/azureRM:AzureRM", name, args ?? new AzureRMArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureRM(string name, Input<string> id, AzureRMState? state = null, CustomResourceOptions? options = null)
            : base("azuredevops:index/azureRM:AzureRM", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new Alias { Type = "azuredevops:ServiceEndpoint/azureRM:AzureRM"},
                },
            };
