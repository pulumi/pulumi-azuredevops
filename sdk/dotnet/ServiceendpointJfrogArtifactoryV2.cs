...
namespace Pulumi.AzureDevOps
{
    ...
    ///     });
    /// 
    ///     var exampleServiceendpointJfrogArtifactoryV2 = new AzureDevOps.Index.ServiceendpointJfrogArtifactoryV2("example", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [AzureDevOpsResourceType("azuredevops:index/serviceendpointJfrogArtifactoryV2:ServiceendpointJfrogArtifactoryV2")]
    public partial class ServiceendpointJfrogArtifactoryV2 : global::Pulumi.CustomResource
    {
        ...
        public ServiceendpointJfrogArtifactoryV2(string name, ServiceendpointJfrogArtifactoryV2Args args, CustomResourceOptions? options = null)
            : base("azuredevops:index/serviceendpointJfrogArtifactoryV2:ServiceendpointJfrogArtifactoryV2", name, args ?? new ServiceendpointJfrogArtifactoryV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceendpointJfrogArtifactoryV2(string name, Input<string> id, ServiceendpointJfrogArtifactoryV2State? state = null, CustomResourceOptions? options = null)
            : base("azuredevops:index/serviceendpointJfrogArtifactoryV2:ServiceendpointJfrogArtifactoryV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceendpointJfrogArtifactoryV2 Get(string name, Input<string> id, ServiceendpointJfrogArtifactoryV2State? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ServiceendpointJfrogArtifactoryV2Args : global::Pulumi.ResourceArgs
    {
        ...
        public ServiceendpointJfrogArtifactoryV2Args()
        {
        }
        public static new ServiceendpointJfrogArtifactoryV2Args Empty => new ServiceendpointJfrogArtifactoryV2Args();
    }
    ...
    public sealed class ServiceendpointJfrogArtifactoryV2State : global::Pulumi.ResourceArgs
    {
        ...
        public ServiceendpointJfrogArtifactoryV2State()
        {
        }
        public static new ServiceendpointJfrogArtifactoryV2State Empty => new ServiceendpointJfrogArtifactoryV2State();
    }
}
