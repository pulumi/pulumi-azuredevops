...
namespace Pulumi.AzureDevOps.Inputs
{
    ...
    public sealed class RepositoryPolicyAuthorEmailPatternSettingsGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.RepositoryPolicyAuthorEmailPatternSettingsScopeGetArgs>? _scopes;

        /// <summary>
        /// Controls which repositories and branches the policy will be enabled for. This block must be defined
        /// at least once.
        /// </summary>
        public InputList<Inputs.RepositoryPolicyAuthorEmailPatternSettingsScopeGetArgs> Scopes
        {
            get => _scopes ?? (_scopes = new InputList<Inputs.RepositoryPolicyAuthorEmailPatternSettingsScopeGetArgs>());
            set => _scopes = value;
        }

        public RepositoryPolicyAuthorEmailPatternSettingsGetArgs()
        {
        }
    }
}
