...
namespace Pulumi.AzureDevOps.Inputs
{
    ...
    public sealed class RepositoryPolicyFilePathPatternSettingsGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.RepositoryPolicyFilePathPatternSettingsScopeGetArgs>? _scopes;

        /// <summary>
        /// Controls which repositories and branches the policy will be enabled for. This block must be defined
        /// at least once.
        /// </summary>
        public InputList<Inputs.RepositoryPolicyFilePathPatternSettingsScopeGetArgs> Scopes
        {
            get => _scopes ?? (_scopes = new InputList<Inputs.RepositoryPolicyFilePathPatternSettingsScopeGetArgs>());
            set => _scopes = value;
        }

        public RepositoryPolicyFilePathPatternSettingsGetArgs()
        {
        }
    }
}
