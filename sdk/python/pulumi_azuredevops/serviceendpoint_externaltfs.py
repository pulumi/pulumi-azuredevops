...
class _ServiceendpointExternaltfsState:
    def __init__(__self__, *,
                 auth_personal: pulumi.Input[Optional['ServiceendpointExternaltfsAuthPersonalArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="authPersonal")
    def auth_personal(self) -> pulumi.Input[Optional['ServiceendpointExternaltfsAuthPersonalArgs']]:
        """
        An `auth_personal` block as documented below. Allows connecting using a personal access token.
        """
        return pulumi.get(self, "auth_personal")
    ...
    @auth_personal.setter
    def auth_personal(self, value: pulumi.Input[Optional['ServiceendpointExternaltfsAuthPersonalArgs']]):
        pulumi.set(self, "auth_personal", value)
...
class ServiceendpointExternaltfs(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auth_personal: pulumi.Input[Optional[Union['ServiceendpointExternaltfsAuthPersonalArgs', 'ServiceendpointExternaltfsAuthPersonalArgsDict', 'outputs.ServiceendpointExternaltfsAuthPersonal']]] = None,
                 connection_url: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 service_endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['ServiceendpointExternaltfsAuthPersonalArgs', 'ServiceendpointExternaltfsAuthPersonalArgsDict', 'outputs.ServiceendpointExternaltfsAuthPersonal']] auth_personal: An `auth_personal` block as documented below. Allows connecting using a personal access token.
        :param pulumi.Input[_builtins.str] connection_url: Azure DevOps Organization or TFS Project Collection Url.
        :param pulumi.Input[_builtins.str] description: The Service Endpoint description. Defaults to `Managed by Terraform`.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project.
        :param pulumi.Input[_builtins.str] service_endpoint_name: The Service Endpoint name.
    ...
    def get(resource_name: str,
            ...
            description: pulumi.Input[Optional[_builtins.str]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            service_endpoint_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServiceendpointExternaltfs':
        """
