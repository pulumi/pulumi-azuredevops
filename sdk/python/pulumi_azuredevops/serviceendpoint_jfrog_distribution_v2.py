...
class ServiceendpointJfrogDistributionV2Args:
    def __init__(__self__, *,
        ...
        """
        ServiceendpointJfrogDistributionV2Args._configure(
    ...
    def authentication_basic(self, value: Optional[pulumi.Input['ServiceendpointJfrogDistributionV2AuthenticationBasicArgs']]):
...
class _ServiceendpointJfrogDistributionV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: URL of the Artifactory server to connect with.
               ...
               > **NOTE:** URL should not end in a slash character.
        """
        _ServiceendpointJfrogDistributionV2State._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication_basic=authentication_basic,
            authentication_token=authentication_token,
            authorization=authorization,
...
class ServiceendpointJfrogDistributionV2(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceendpointJfrogDistributionV2Args._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication_basic is not None and not isinstance(authentication_basic, ServiceendpointJfrogDistributionV2AuthenticationBasicArgs):
                authentication_basic = authentication_basic or {}
                def _setter(key, value):
                    authentication_basic[key] = value
                ServiceendpointJfrogDistributionV2AuthenticationBasicArgs._configure(_setter, **authentication_basic)
            __props__.__dict__["authentication_basic"] = authentication_basic
            if authentication_token is not None and not isinstance(authentication_token, ServiceendpointJfrogDistributionV2AuthenticationTokenArgs):
                authentication_token = authentication_token or {}
                def _setter(key, value):
                    authentication_token[key] = value
                ServiceendpointJfrogDistributionV2AuthenticationTokenArgs._configure(_setter, **authentication_token)
