...
class RepositoryPolicyCaseEnforcementArgs:
    def __init__(__self__, *,
        ...
        """
        RepositoryPolicyCaseEnforcementArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            enforce_consistent_case=enforce_consistent_case,
    ...
    def _configure(
             ...
             **kwargs):
        if enforce_consistent_case is None and 'enforceConsistentCase' in kwargs:
            enforce_consistent_case = kwargs['enforceConsistentCase']
        if enforce_consistent_case is None:
            raise TypeError("Missing 'enforce_consistent_case' argument")
        ...
        _setter("enforce_consistent_case", enforce_consistent_case)
...
class _RepositoryPolicyCaseEnforcementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] repository_ids: Control whether the policy is enabled for the repository or the project. If `repository_ids` not configured, the policy will be set to the project.
        """
        _RepositoryPolicyCaseEnforcementState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            blocking=blocking,
            enabled=enabled,
            enforce_consistent_case=enforce_consistent_case,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RepositoryPolicyCaseEnforcementArgs._configure(_setter, **kwargs)
