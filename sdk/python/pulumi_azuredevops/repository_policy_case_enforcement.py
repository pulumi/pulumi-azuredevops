...
class RepositoryPolicyCaseEnforcementArgs:
    def __init__(__self__, *,
                 enforce_consistent_case: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] enforce_consistent_case: Avoid case-sensitivity conflicts by blocking pushes that change name casing on files, folders, branches, and tags.
    ...
    def enforce_consistent_case(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enforce_consistent_case(self, value: pulumi.Input[builtins.bool]):
...
class _RepositoryPolicyCaseEnforcementState:
    def __init__(__self__, *,
                 blocking: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 enforce_consistent_case: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="enforceConsistentCase")
    def enforce_consistent_case(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Avoid case-sensitivity conflicts by blocking pushes that change name casing on files, folders, branches, and tags.
        """
        return pulumi.get(self, "enforce_consistent_case")
    ...
    @enforce_consistent_case.setter
    def enforce_consistent_case(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enforce_consistent_case", value)
...
class RepositoryPolicyCaseEnforcement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enforce_consistent_case: Optional[pulumi.Input[builtins.bool]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            repository_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RepositoryPolicyCaseEnforcement':
        """
    ...
    @property
    @pulumi.getter(name="enforceConsistentCase")
    def enforce_consistent_case(self) -> pulumi.Output[builtins.bool]:
        """
        Avoid case-sensitivity conflicts by blocking pushes that change name casing on files, folders, branches, and tags.
        """
        return pulumi.get(self, "enforce_consistent_case")
