...
class ServiceendpointPermissions(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        project_readers = azuredevops.get_group_output(project_id=project.id,
            name="Readers")
        root_permissions = azuredevops.ServiceendpointPermissions("root-permissions",
        ...
        serviceendpoint_permissions = azuredevops.ServiceendpointPermissions("serviceendpoint-permissions",
            project_id=project.id,
            principal=project_readers.id,
            serviceendpoint_id=dockerhubregistry.id,
            permissions={
                "Use": "allow",
                "Administer": "deny",
                "Create": "deny",
