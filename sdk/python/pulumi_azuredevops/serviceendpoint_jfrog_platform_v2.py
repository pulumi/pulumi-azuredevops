...
class ServiceendpointJfrogPlatformV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication_basic = _utilities.configure(authentication_basic, ServiceendpointJfrogPlatformV2AuthenticationBasicArgs, True)
            __props__.__dict__["authentication_basic"] = authentication_basic
            authentication_token = _utilities.configure(authentication_token, ServiceendpointJfrogPlatformV2AuthenticationTokenArgs, True)
