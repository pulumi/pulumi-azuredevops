...
class BranchPolicyWorkItemLinking(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if settings is not None and not isinstance(settings, BranchPolicyWorkItemLinkingSettingsArgs):
                settings = settings or {}
                def _setter(key, value):
                    settings[key] = value
                BranchPolicyWorkItemLinkingSettingsArgs._configure(_setter, **settings)
