...
class _RepositoryPolicyAuthorEmailPatternState:
    def __init__(__self__, *,
                 author_email_patterns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 blocking: pulumi.Input[Optional[_builtins.bool]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="authorEmailPatterns")
    def author_email_patterns(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Block pushes with a commit author email that does not match the patterns. You can specify exact emails or use wildcards.
    ...
    @author_email_patterns.setter
    def author_email_patterns(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "author_email_patterns", value)
...
class RepositoryPolicyAuthorEmailPattern(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            repository_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'RepositoryPolicyAuthorEmailPattern':
        """
