...
class ServiceEndpointArtifactoryArgs:
    def __init__(__self__, *,
        ...
        """
        ServiceEndpointArtifactoryArgs._configure(
...
class _ServiceEndpointArtifactoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: URL of the Artifactory server to connect with.
               ...
               * either `authentication_token` or `authentication_basic` (one is required)
        """
        _ServiceEndpointArtifactoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication_basic=authentication_basic,
            authentication_token=authentication_token,
            authorization=authorization,
...
class ServiceEndpointArtifactory(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceEndpointArtifactoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication_basic is not None and not isinstance(authentication_basic, ServiceEndpointArtifactoryAuthenticationBasicArgs):
                authentication_basic = authentication_basic or {}
                def _setter(key, value):
                    authentication_basic[key] = value
                ServiceEndpointArtifactoryAuthenticationBasicArgs._configure(_setter, **authentication_basic)
            __props__.__dict__["authentication_basic"] = authentication_basic
            if authentication_token is not None and not isinstance(authentication_token, ServiceEndpointArtifactoryAuthenticationTokenArgs):
                authentication_token = authentication_token or {}
                def _setter(key, value):
                    authentication_token[key] = value
                ServiceEndpointArtifactoryAuthenticationTokenArgs._configure(_setter, **authentication_token)
