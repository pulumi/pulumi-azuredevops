...
class BranchPolicyCommentResolutionArgs:
    def __init__(__self__, *,
        ...
        """
        BranchPolicyCommentResolutionArgs._configure(
...
class _BranchPolicyCommentResolutionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BranchPolicyCommentResolutionSettingsArgs'] settings: Configuration for the policy. This block must be defined exactly once.
        """
        _BranchPolicyCommentResolutionState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            blocking=blocking,
            enabled=enabled,
            project_id=project_id,
...
class BranchPolicyCommentResolution(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BranchPolicyCommentResolutionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if settings is not None and not isinstance(settings, BranchPolicyCommentResolutionSettingsArgs):
                settings = settings or {}
                def _setter(key, value):
                    settings[key] = value
                BranchPolicyCommentResolutionSettingsArgs._configure(_setter, **settings)
