...
class WikiPageArgs:
    def __init__(__self__, *,
                 ...
                 wiki_id: pulumi.Input[builtins.str],
                 etag: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WikiPage resource.
        :param pulumi.Input[builtins.str] content: The content of the wiki page.
        :param pulumi.Input[builtins.str] path: The path of the wiki page.
        :param pulumi.Input[builtins.str] project_id: The ID of the Project.
        :param pulumi.Input[builtins.str] wiki_id: The ID of the Wiki.
        """
    ...
    def wiki_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Wiki.
        """
    ...
    @wiki_id.setter
    def wiki_id(self, value: pulumi.Input[builtins.str]):
...
class _WikiPageState:
    def __init__(__self__, *,
                 ...
                 wiki_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="wikiId")
    def wiki_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Wiki.
        """
        return pulumi.get(self, "wiki_id")
    ...
    @wiki_id.setter
    def wiki_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "wiki_id", value)
...
class WikiPage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            path: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            wiki_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WikiPage':
        """
    ...
    @property
    @pulumi.getter(name="wikiId")
    def wiki_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Wiki.
        """
        return pulumi.get(self, "wiki_id")
