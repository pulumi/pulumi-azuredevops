...
class ServiceEndpointGitHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auth_oauth = _utilities.configure(auth_oauth, ServiceEndpointGitHubAuthOauthArgs, True)
            __props__.__dict__["auth_oauth"] = auth_oauth
            auth_personal = _utilities.configure(auth_personal, ServiceEndpointGitHubAuthPersonalArgs, True)
