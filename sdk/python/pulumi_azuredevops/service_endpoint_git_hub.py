...
class ServiceEndpointGitHubArgs:
    def __init__(__self__, *,
        ...
        """
        ServiceEndpointGitHubArgs._configure(
...
class _ServiceEndpointGitHubState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service_endpoint_name: The Service Endpoint name.
        """
        _ServiceEndpointGitHubState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            auth_oauth=auth_oauth,
            auth_personal=auth_personal,
            authorization=authorization,
...
class ServiceEndpointGitHub(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceEndpointGitHubArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auth_oauth is not None and not isinstance(auth_oauth, ServiceEndpointGitHubAuthOauthArgs):
                auth_oauth = auth_oauth or {}
                def _setter(key, value):
                    auth_oauth[key] = value
                ServiceEndpointGitHubAuthOauthArgs._configure(_setter, **auth_oauth)
            __props__.__dict__["auth_oauth"] = auth_oauth
            if auth_personal is not None and not isinstance(auth_personal, ServiceEndpointGitHubAuthPersonalArgs):
                auth_personal = auth_personal or {}
                def _setter(key, value):
                    auth_personal[key] = value
                ServiceEndpointGitHubAuthPersonalArgs._configure(_setter, **auth_personal)
