...
class BuildDefinitionCiTriggerOverrideBranchFilter(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[str] includes: List of branch patterns to include.`include` - (Optional) List of branch patterns to include.
        """
...
class BuildDefinitionPullRequestTriggerOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['BuildDefinitionPullRequestTriggerOverrideBranchFilterArgs'] branch_filters: The branches to include and exclude from the trigger.`branch_filter` - (Optional) The branches to include and exclude from the trigger.
        :param Sequence['BuildDefinitionPullRequestTriggerOverridePathFilterArgs'] path_filters: Specify file paths to include or exclude. Note that the wildcard syntax is different between branches/tags and file paths.`path_filter` - (Optional) Specify file paths to include or exclude. Note that the wildcard syntax is different between branches/tags and file paths.
        """
...
class BuildDefinitionSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['BuildDefinitionScheduleBranchFilterArgs'] branch_filters: The branches to include and exclude from the trigger.`branch_filter` - (Optional) The branches to include and exclude from the trigger.
