...
class BuildDefinition(pulumi.CustomResource):
    ...
    def ci_trigger(self) -> Optional['outputs.BuildDefinitionCiTrigger']:
        """
    ...
    def pull_request_trigger(self) -> Optional['outputs.BuildDefinitionPullRequestTrigger']:
        """
    ...
    @property
    @pulumi.getter
    def repository(self) -> 'outputs.BuildDefinitionRepository':
        """
    ...
    def variable_groups(self) -> Optional[List[float]]:
        """
    ...
    @property
    @pulumi.getter
    def variables(self) -> Optional[List['outputs.BuildDefinitionVariable']]:
        """
