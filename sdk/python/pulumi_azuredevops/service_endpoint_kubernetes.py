...
class ServiceEndpointKubernetes(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 azure_subscriptions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesAzureSubscriptionArgs']]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 kubeconfigs: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesKubeconfigArgs']]]]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 service_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesServiceAccountArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesAzureSubscriptionArgs']]]] azure_subscriptions: The configuration for authorization_type="AzureSubscription".
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesKubeconfigArgs']]]] kubeconfigs: The configuration for authorization_type="Kubeconfig".
        :param pulumi.Input[str] project_id: The project ID or project name.
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceEndpointKubernetesServiceAccountArgs']]]] service_accounts: The configuration for authorization_type="ServiceAccount". This type uses the credentials of a service account currently deployed to the cluster.
    ...
    def azure_subscriptions(self) -> pulumi.Output[Optional[List['outputs.ServiceEndpointKubernetesAzureSubscription']]]:
        """
    ...
    @property
    @pulumi.getter
    def kubeconfigs(self) -> pulumi.Output[Optional[List['outputs.ServiceEndpointKubernetesKubeconfig']]]:
        """
    ...
    def service_accounts(self) -> pulumi.Output[Optional[List['outputs.ServiceEndpointKubernetesServiceAccount']]]:
        """
