...
class ServiceEndpointKubernetes(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            kubeconfig = _utilities.configure(kubeconfig, ServiceEndpointKubernetesKubeconfigArgs, True)
            __props__.__dict__["kubeconfig"] = kubeconfig
            if project_id is None and not opts.urn:
                raise TypeError("Missing required property 'project_id'")
            __props__.__dict__["project_id"] = project_id
            service_account = _utilities.configure(service_account, ServiceEndpointKubernetesServiceAccountArgs, True)
