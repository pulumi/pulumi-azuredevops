...
class ServiceendpointMaven(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication_basic is not None and not isinstance(authentication_basic, ServiceendpointMavenAuthenticationBasicArgs):
                authentication_basic = authentication_basic or {}
                def _setter(key, value):
                    authentication_basic[key] = value
                ServiceendpointMavenAuthenticationBasicArgs._configure(_setter, **authentication_basic)
            __props__.__dict__["authentication_basic"] = authentication_basic
            if authentication_token is not None and not isinstance(authentication_token, ServiceendpointMavenAuthenticationTokenArgs):
                authentication_token = authentication_token or {}
                def _setter(key, value):
                    authentication_token[key] = value
                ServiceendpointMavenAuthenticationTokenArgs._configure(_setter, **authentication_token)
