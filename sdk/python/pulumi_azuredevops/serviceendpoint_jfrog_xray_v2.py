...
class ServiceendpointJfrogXrayV2Args:
    def __init__(__self__, *,
                 ...
                 authentication_basic: pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationBasicArgs']] = None,
                 authentication_token: pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationTokenArgs']] = None,
    ...
    def authentication_basic(self) -> pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationBasicArgs']]:
        """
    ...
    def authentication_basic(self, value: pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationBasicArgs']]):
        pulumi.set(self, "authentication_basic", value)

    @_builtins.property
    @pulumi.getter(name="authenticationToken")
    def authentication_token(self) -> pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationTokenArgs']]:
        """
    ...
    def authentication_token(self, value: pulumi.Input[Optional['ServiceendpointJfrogXrayV2AuthenticationTokenArgs']]):
...
class ServiceendpointJfrogXrayV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 authentication_basic: pulumi.Input[Optional[Union['ServiceendpointJfrogXrayV2AuthenticationBasicArgs', 'ServiceendpointJfrogXrayV2AuthenticationBasicArgsDict', 'outputs.ServiceendpointJfrogXrayV2AuthenticationBasic']]] = None,
                 authentication_token: pulumi.Input[Optional[Union['ServiceendpointJfrogXrayV2AuthenticationTokenArgs', 'ServiceendpointJfrogXrayV2AuthenticationTokenArgsDict', 'outputs.ServiceendpointJfrogXrayV2AuthenticationToken']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 service_endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
                 url: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * [Artifactory User Token](https://docs.artifactory.org/latest/user-guide/user-token/)
        ...
        :param pulumi.Input[Union['ServiceendpointJfrogXrayV2AuthenticationBasicArgs', 'ServiceendpointJfrogXrayV2AuthenticationBasicArgsDict', 'outputs.ServiceendpointJfrogXrayV2AuthenticationBasic']] authentication_basic: An `authentication_basic` block as documented below.
        :param pulumi.Input[Union['ServiceendpointJfrogXrayV2AuthenticationTokenArgs', 'ServiceendpointJfrogXrayV2AuthenticationTokenArgsDict', 'outputs.ServiceendpointJfrogXrayV2AuthenticationToken']] authentication_token: An `authentication_token` block as documented below.
        :param pulumi.Input[_builtins.str] description: The Service Endpoint description.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project.
        :param pulumi.Input[_builtins.str] service_endpoint_name: The Service Endpoint name.
        :param pulumi.Input[_builtins.str] url: URL of the Artifactory server to connect with.
    ...
    def get(resource_name: str,
            ...
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            service_endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
            url: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServiceendpointJfrogXrayV2':
        """
