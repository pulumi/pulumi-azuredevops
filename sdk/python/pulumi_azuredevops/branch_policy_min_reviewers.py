...
class _BranchPolicyMinReviewersState:
    def __init__(__self__, *,
                 ...
                 settings: pulumi.Input[Optional['BranchPolicyMinReviewersSettingsArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def settings(self) -> pulumi.Input[Optional['BranchPolicyMinReviewersSettingsArgs']]:
        """
        A `settings` block as defined below.. This block must be defined exactly once.
        """
        return pulumi.get(self, "settings")
    ...
    @settings.setter
    def settings(self, value: pulumi.Input[Optional['BranchPolicyMinReviewersSettingsArgs']]):
        pulumi.set(self, "settings", value)
