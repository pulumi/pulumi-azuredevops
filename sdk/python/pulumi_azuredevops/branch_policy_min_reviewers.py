...
class BranchPolicyMinReviewersArgs:
    def __init__(__self__, *,
        ...
        """
        BranchPolicyMinReviewersArgs._configure(
...
class _BranchPolicyMinReviewersState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BranchPolicyMinReviewersSettingsArgs'] settings: A `settings` block as defined below.. This block must be defined exactly once.
        """
        _BranchPolicyMinReviewersState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            blocking=blocking,
            enabled=enabled,
            project_id=project_id,
...
class BranchPolicyMinReviewers(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BranchPolicyMinReviewersArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if settings is not None and not isinstance(settings, BranchPolicyMinReviewersSettingsArgs):
                settings = settings or {}
                def _setter(key, value):
                    settings[key] = value
                BranchPolicyMinReviewersSettingsArgs._configure(_setter, **settings)
