...
class ServiceendpointJfrogArtifactoryV2Args:
    def __init__(__self__, *,
        ...
        """
        ServiceendpointJfrogArtifactoryV2Args._configure(
...
class _ServiceendpointJfrogArtifactoryV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: URL of the Artifactory server to connect with.
               ...
               > **NOTE:** URL should not end in a slash character.
        """
        _ServiceendpointJfrogArtifactoryV2State._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication_basic=authentication_basic,
            authentication_token=authentication_token,
            authorization=authorization,
...
class ServiceendpointJfrogArtifactoryV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 authentication_basic: Optional[pulumi.Input[pulumi.InputType['ServiceendpointJfrogArtifactoryV2AuthenticationBasicArgs']]] = None,
                 authentication_token: Optional[pulumi.Input[pulumi.InputType['ServiceendpointJfrogArtifactoryV2AuthenticationTokenArgs']]] = None,
                 authorization: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 service_endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceendpointJfrogArtifactoryV2Args._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication_basic is not None and not isinstance(authentication_basic, ServiceendpointJfrogArtifactoryV2AuthenticationBasicArgs):
                authentication_basic = authentication_basic or {}
                def _setter(key, value):
                    authentication_basic[key] = value
                ServiceendpointJfrogArtifactoryV2AuthenticationBasicArgs._configure(_setter, **authentication_basic)
            __props__.__dict__["authentication_basic"] = authentication_basic
            if authentication_token is not None and not isinstance(authentication_token, ServiceendpointJfrogArtifactoryV2AuthenticationTokenArgs):
                authentication_token = authentication_token or {}
                def _setter(key, value):
                    authentication_token[key] = value
                ServiceendpointJfrogArtifactoryV2AuthenticationTokenArgs._configure(_setter, **authentication_token)
