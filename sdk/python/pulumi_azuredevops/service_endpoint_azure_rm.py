...
class ServiceEndpointAzureRM(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = azuredevops.Project("example",
            ...
            work_item_template="Agile",
            description="Managed by Pulumi")
        identity = azurerm.ResourceGroup("identity",
            name=identity,
            location=UK South)
        example_user_assigned_identity = azurerm.UserAssignedIdentity("example",
        ...
        example_service_endpoint_azure_rm = azuredevops.ServiceEndpointAzureRM("example",
            ...
            azurerm_subscription_id="00000000-0000-0000-0000-000000000000",
            azurerm_subscription_name="Example Subscription Name")
        example_federated_identity_credential = azurerm.FederatedIdentityCredential("example",
