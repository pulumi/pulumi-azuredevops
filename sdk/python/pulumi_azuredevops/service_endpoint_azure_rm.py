...
class ServiceEndpointAzureRMArgs:
    def __init__(__self__, *,
        ...
        """
        ServiceEndpointAzureRMArgs._configure(
...
class _ServiceEndpointAzureRMState:
    def __init__(__self__, *,
        ...
        """
        _ServiceEndpointAzureRMState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authorization=authorization,
            azurerm_management_group_id=azurerm_management_group_id,
            azurerm_management_group_name=azurerm_management_group_name,
...
class ServiceEndpointAzureRM(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServiceEndpointAzureRMArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if credentials is not None and not isinstance(credentials, ServiceEndpointAzureRMCredentialsArgs):
                credentials = credentials or {}
                def _setter(key, value):
                    credentials[key] = value
                ServiceEndpointAzureRMCredentialsArgs._configure(_setter, **credentials)
