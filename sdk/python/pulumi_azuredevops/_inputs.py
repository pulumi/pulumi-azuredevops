...
class BranchPolicyAutoReviewersSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] message: Activity feed message, Message will appear in the activity feed of pull requests with automatically added reviewers.
        :param pulumi.Input[_builtins.int] minimum_number_of_reviewers: Minimum number of required reviewers. Defaults to `1`.
               
               > **Note** Has to be greater than `0`. Can only be greater than `1` when attribute `auto_reviewer_ids` contains exactly one group! Only has an effect when attribute `blocking` is set to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] path_filters: Filter path(s) on which the policy is applied. Supports absolute paths, wildcards and multiple paths. Example: /WebApp/Models/Data.cs, /WebApp/* or *.cs,/WebApp/Models/Data.cs;ClientApp/Models/Data.cs.
        :param pulumi.Input[_builtins.bool] submitter_can_vote: Controls whether or not the submitter's vote counts. Defaults to `false`.
        """
    ...
    def auto_reviewer_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        Required reviewers ids. Supports multiples user Ids.
        """
    ...
    def auto_reviewer_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class BranchPolicyAutoReviewersSettingsScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repository_ref: The ref pattern to use for the match when `match_type` other than `DefaultBranch`. If `match_type` is `Exact`, this should be a qualified ref such as `refs/heads/master`. If `match_type` is `Prefix`, this should be a ref path such as `refs/heads/releases`.
        """
...
class BranchPolicyBuildValidationSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] filename_patterns: If a path filter is set, the policy will only apply when files which match the filter are changes. Not setting this field means that the policy will always apply. You can specify absolute paths and wildcards. Example: `["/WebApp/Models/Data.cs", "/WebApp/*", "*.cs"]`. Paths prefixed with "!" are excluded. Example: `["/WebApp/*", "!/WebApp/Tests/*"]`. Order is significant.
        :param pulumi.Input[_builtins.bool] manual_queue_only: If set to true, the build will need to be manually queued. Defaults to `false`
        :param pulumi.Input[_builtins.bool] queue_on_source_update_only: True if the build should queue on source updates only. Defaults to `true`.
        :param pulumi.Input[_builtins.int] valid_duration: The number of minutes for which the build is valid. If `0`, the build will not expire. Defaults to `720` (12 hours).
    ...
    def build_definition_id(self) -> pulumi.Input[_builtins.int]:
        """
        The ID of the build to monitor for the policy.
        """
    ...
    def build_definition_id(self, value: pulumi.Input[_builtins.int]):
...
class BranchPolicyMergeTypesSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_rebase_and_fast_forward: Allow rebase with fast forward. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] allow_rebase_with_merge: Allow rebase with merge commit. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] allow_squash: Allow squash merge. Defaults to `false`
        """
        pulumi.set(__self__, "scopes", scopes)
...
class BranchPolicyStatusCheckSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] applicability: Policy applicability. If policy `applicability=default`, apply unless "Not Applicable"
               status is posted to the pull request. If policy `applicability=conditional`, policy is applied only after a status
               is posted to the pull request. Possible values `default`, `conditional`. Defaults to `default`.
        :param pulumi.Input[_builtins.str] author_id: The authorized user can post the status.
        :param pulumi.Input[_builtins.str] display_name: The display name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] filename_patterns: If a path filter is set, the policy will only apply when files which match the filter are changed. Not setting this field means that the policy is always applied.
               
               ~>**NOTE** 1. Specify absolute paths and wildcards. Example: `["/WebApp/Models/Data.cs", "/WebApp/*", "*.cs"]`.
               <br> 2. Paths prefixed with "!" are excluded. Example: `["/WebApp/*", "!/WebApp/Tests/*"]`. Order is significant.
        :param pulumi.Input[_builtins.str] genre: The genre of the status to check (see [Microsoft Documentation](https://docs.microsoft.com/en-us/azure/devops/repos/git/pull-request-status?view=azure-devops#status-policy))
        :param pulumi.Input[_builtins.bool] invalidate_on_update: Reset status whenever there are new changes.
        """
...
class BranchPolicyStatusCheckSettingsScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repository_ref: The ref pattern to use for the match when `match_type` other than `DefaultBranch`. If `match_type=Exact`, this should be a qualified ref such as `refs/heads/master`. If `match_type=Prefix`, this should be a ref path such as `refs/heads/releases`.
        """
        if match_type is not None:
            pulumi.set(__self__, "match_type", match_type)
        if repository_id is not None:
...
class BuildDefinitionBuildCompletionTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] build_definition_id: The ID of the build pipeline will be triggered.
        """
...
class BuildDefinitionCiTriggerOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_concurrent_builds_per_branch: The number of max builds per branch. Defaults to `1`.
        ...
        :param pulumi.Input[_builtins.int] polling_interval: How often the external repository is polled. Defaults to `0`.
        :param pulumi.Input[_builtins.str] polling_job_id: This is the ID of the polling job that polls the external repository. Once the build definition is saved/updated, this value is set.
        """
        pulumi.set(__self__, "branch_filters", branch_filters)
...
class BuildDefinitionJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ref_name: The reference name of the job, can be used to define the job dependencies.
        :param pulumi.Input['BuildDefinitionJobTargetArgs'] target: A `target` blocks as documented below.
        :param pulumi.Input[_builtins.bool] allow_scripts_auth_access_option: Enables scripts and other processes launched by tasks to access the OAuth token through the `System.AccessToken` variable. Possible values: `true`, `false`. Defaults to `false`. Available when Job type is `AgentJob`
        ...
        :param pulumi.Input[_builtins.int] job_cancel_timeout_in_minutes: The job cancel timeout (in minutes) for builds cancelled by user for this definition. Possible values are between `0` and `60`. Defaults to `0`.
        :param pulumi.Input[_builtins.int] job_timeout_in_minutes: The job execution timeout (in minutes) for builds queued against this definition. Possible values are between `0` and `1000000000`. Defaults to `0`.
        """
...
class BuildDefinitionJobDependencyArgs:
    def __init__(__self__, *,
                 scope: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] scope: The job reference name that depends on. Reference to `jobs.ref_name`
        """
...
class BuildDefinitionJobTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] demands: A list of demands that represents the agent capabilities required by this build. Example: `git`
        """
...
class BuildDefinitionJobTargetExecutionOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_concurrency: Limit the number of agents to be used. If job type is `AgentlessJob`, the concurrency is not configurable and is fixed to 50.
        :param pulumi.Input[_builtins.str] multipliers: A list of comma separated configuration variables to use. These are defined on the Variables tab. For example, OperatingSystem, Browser will run the tasks for both variables. Available when `execution_options.type` is `Multi-Configuration`.
        """
        pulumi.set(__self__, "type", type)
...
class BuildDefinitionPullRequestTriggerForksArgs:
    def __init__(__self__, *,
                 ...
                 share_secrets: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Build pull requests from forks of this repository.
        :param pulumi.Input[_builtins.bool] share_secrets: Make secrets available to builds of forks.
        """
    ...
    def share_secrets(self) -> pulumi.Input[_builtins.bool]:
        """
        Make secrets available to builds of forks.
        """
    ...
    def share_secrets(self, value: pulumi.Input[_builtins.bool]):
...
class BuildDefinitionRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] branch_name: The branch name for which builds are triggered. Defaults to `master`.
        :param pulumi.Input[_builtins.str] github_enterprise_url: The Github Enterprise URL. Used if `repo_type` is `GithubEnterprise`. Conflict with `url`
        :param pulumi.Input[_builtins.bool] report_build_status: Report build status. Default is true.
        :param pulumi.Input[_builtins.str] service_connection_id: The service connection ID. Used if the `repo_type` is `GitHub` or `GitHubEnterprise`.
        :param pulumi.Input[_builtins.str] url: The URL of the Git repository. Used if `repo_type` is `Git`. Conflict with `github_enterprise_url`
        :param pulumi.Input[_builtins.str] yml_path: The path of the Yaml file describing the build definition.
        """
...
class BuildDefinitionScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schedule_job_id: The ID of the schedule job
        :param pulumi.Input[_builtins.bool] schedule_only_with_changes: Schedule builds if the source or pipeline has changed. Defaults to `true`.
        :param pulumi.Input[_builtins.int] start_hours: Build start hour. Possible values are: `0 ~ 23`. Defaults to `0`.
        :param pulumi.Input[_builtins.int] start_minutes: Build start minute. Possible values are: `0 ~ 59`. Defaults to `0`.
        :param pulumi.Input[_builtins.str] time_zone: Build time zone. Defaults to `(UTC) Coordinated Universal Time`. Possible values are:
               `(UTC-12:00) International Date Line West`,
               `(UTC-11:00) Coordinated Universal Time-11`,
               `(UTC-10:00) Aleutian Islands`,
               `(UTC-10:00) Hawaii`,
    ...
    def days_to_builds(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        When to build. Possible values are: `Mon`, `Tue`, `Wed`, `Thu`, `Fri`, `Sat`, `Sun`.
        """
    ...
    def days_to_builds(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class BuildDefinitionVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_secret: True if the variable is a secret. Defaults to `false`.
        :param pulumi.Input[_builtins.str] secret_value: The secret value of the variable. Used when `is_secret` set to `true`.
...
class CheckRequiredTemplateRequiredTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] template_path: The path to the template yaml.
        :param pulumi.Input[_builtins.str] repository_type: The type of the repository storing the template. Possible values are: `azuregit`, `github`, `githubenterprise`, `bitbucket`. Defaults to `azuregit`.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="repositoryRef")
    def repository_ref(self) -> pulumi.Input[_builtins.str]:
        """
        The branch in which the template will be referenced.
        """
        return pulumi.get(self, "repository_ref")
    ...
    @repository_ref.setter
    def repository_ref(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "repository_ref", value)

    @_builtins.property
    @pulumi.getter(name="templatePath")
    def template_path(self) -> pulumi.Input[_builtins.str]:
        """
        The path to the template yaml.
        """
    ...
    def template_path(self, value: pulumi.Input[_builtins.str]):
...
class GitInitializationArgs:
    ...
    def init_type(self) -> pulumi.Input[_builtins.str]:
        """
        The type of repository to create. Valid values: `Uninitialized`, `Clean` or `Import`.
        """
...
class ServiceEndpointArtifactoryAuthenticationBasicArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The Password of the Artifactory.
        :param pulumi.Input[_builtins.str] username: The Username of the Artifactory.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class ServiceEndpointArtifactoryAuthenticationTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: Authentication Token generated through Artifactory.
        """
...
class ServiceEndpointAzureEcrCredentialsArgs:
    def __init__(__self__, *,
                 serviceprincipalid: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] serviceprincipalid: The ID of the Service Principal Application.
        """
        pulumi.set(__self__, "serviceprincipalid", serviceprincipalid)

    @_builtins.property
    @pulumi.getter
    def serviceprincipalid(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the Service Principal Application.
        """
    ...
    def serviceprincipalid(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointAzureRMCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] serviceprincipalkey: The service principal secret. This not required if `service_endpoint_authentication_scheme` is set to `WorkloadIdentityFederation`.
        """
        pulumi.set(__self__, "serviceprincipalid", serviceprincipalid)
...
class ServiceEndpointGitHubAuthOauthArgs:
    ...
    def oauth_configuration_id(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointGitHubAuthPersonalArgs:
    def __init__(__self__, *,
                 personal_access_token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] personal_access_token: The Personal Access Token for GitHub.
        """
        pulumi.set(__self__, "personal_access_token", personal_access_token)

    @_builtins.property
    @pulumi.getter(name="personalAccessToken")
    def personal_access_token(self) -> pulumi.Input[_builtins.str]:
        """
        The Personal Access Token for GitHub.
        """
    ...
    def personal_access_token(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointKubernetesAzureSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subscription_id: The id of the Azure subscription.
        :param pulumi.Input[_builtins.str] subscription_name: The name of the Azure subscription.
        :param pulumi.Input[_builtins.str] tenant_id: The id of the tenant used by the subscription.
        :param pulumi.Input[_builtins.str] azure_environment: Azure environment refers to whether the public cloud offering or domestic (government) clouds are being used. Currently, only the public cloud is supported. The value must be AzureCloud. This is also the default-value.
        :param pulumi.Input[_builtins.bool] cluster_admin: Set this option to allow use cluster admin credentials.
        :param pulumi.Input[_builtins.str] namespace: The Kubernetes namespace. Default value is "default".
        """
    ...
    def resourcegroup_id(self) -> pulumi.Input[_builtins.str]:
        """
        The resource group name, to which the Kubernetes cluster is deployed.
        """
    ...
    def resourcegroup_id(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointKubernetesKubeconfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_context: Context within the kubeconfig file that is to be used for identifying the cluster. Default value is the current-context set in kubeconfig.
        """
...
class ServiceEndpointKubernetesServiceAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] accept_untrusted_certs: Set this option to allow clients to accept a self-signed certificate. Defaults to `false`.
        """
    ...
    def ca_cert(self) -> pulumi.Input[_builtins.str]:
        """
        The certificate from a Kubernetes secret object.
        """
    ...
    @ca_cert.setter
    def ca_cert(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointPipelineAuthPersonalArgs:
    def __init__(__self__, *,
                 personal_access_token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] personal_access_token: The Personal Access Token for Azure DevOps Pipeline. It also can be set with AZDO_PERSONAL_ACCESS_TOKEN environment variable.
        """
        pulumi.set(__self__, "personal_access_token", personal_access_token)
...
class ServiceEndpointServiceFabricAzureActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] username: Specify an Azure Active Directory account.
        :param pulumi.Input[_builtins.str] server_certificate_common_name: The common name(s) of the cluster's certificate(s). This is used to verify the identity of the cluster. This value overrides the publish profile. Separate multiple common names with a comma (',')
        :param pulumi.Input[_builtins.str] server_certificate_thumbprint: The thumbprint(s) of the cluster's certificate(s). This is used to verify the identity of the cluster. This value overrides the publish profile. Separate multiple thumbprints with a comma (',')
        """
        pulumi.set(__self__, "password", password)
    ...
    def server_certificate_lookup(self) -> pulumi.Input[_builtins.str]:
        """
        Verification mode for the cluster. Possible values are: `Thumbprint`, `CommonName`.
        """
    ...
    def server_certificate_lookup(self, value: pulumi.Input[_builtins.str]):
...
class ServiceEndpointServiceFabricCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] server_certificate_lookup: Verification mode for the cluster. Possible values are: `Thumbprint`, `CommonName`.
        :param pulumi.Input[_builtins.str] client_certificate_password: Password for the certificate.
        :param pulumi.Input[_builtins.str] server_certificate_common_name: The common name(s) of the cluster's certificate(s). This is used to verify the identity of the cluster. This value overrides the publish profile. Separate multiple common names with a comma (',')
        :param pulumi.Input[_builtins.str] server_certificate_thumbprint: The thumbprint(s) of the cluster's certificate(s). This is used to verify the identity of the cluster. This value overrides the publish profile. Separate multiple thumbprints with a comma (',')
        """
...
class ServiceendpointArgocdAuthenticationBasicArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The Password of the ArgoCD.
        :param pulumi.Input[_builtins.str] username: The Username of the ArgoCD.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class ServiceendpointArgocdAuthenticationTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: Authentication Token generated through ArgoCD.
        """
        pulumi.set(__self__, "token", token)
...
class ServiceendpointExternaltfsAuthPersonalArgs:
    def __init__(__self__, *,
                 personal_access_token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] personal_access_token: The Personal Access Token for Azure DevOps Organization.
        """
        pulumi.set(__self__, "personal_access_token", personal_access_token)
...
class ServiceendpointJfrogDistributionV2AuthenticationTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: The Authentication Token generated through Artifactory.
        """
        pulumi.set(__self__, "token", token)
...
class ServiceendpointMavenAuthenticationBasicArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The password Maven Repository.
        :param pulumi.Input[_builtins.str] username: The Username of the Maven Repository.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class ServiceendpointMavenAuthenticationTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: Authentication Token generated through maven repository.
        """
        pulumi.set(__self__, "token", token)
...
class ServiceendpointOpenshiftAuthTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: The API token.
        """
        pulumi.set(__self__, "token", token)
...
class ServiceendpointVisualstudiomarketplaceAuthenticationBasicArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The password of the marketplace.
        :param pulumi.Input[_builtins.str] username: The username of the marketplace.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class ServiceendpointVisualstudiomarketplaceAuthenticationTokenArgs:
    def __init__(__self__, *,
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] token: The Personal Access Token.
        """
        pulumi.set(__self__, "token", token)
...
class ServicehookStorageQueuePipelinesRunStateChangedEventArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] run_state_filter: Which run state should generate an event. Only valid if published_event is `RunStateChanged`. If not specified, all states will trigger the event.
        """
...
class ServicehookStorageQueuePipelinesStageStateChangedEventArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] stage_result_filter: Which stage result should generate an event. Only valid if published_event is `StageStateChanged`. If not specified, all results will trigger the event.
        :param pulumi.Input[_builtins.str] stage_state_filter: Which stage state should generate an event. Only valid if published_event is `StageStateChanged`. If not specified, all states will trigger the event.
        """
        if pipeline_id is not None:
            pulumi.set(__self__, "pipeline_id", pipeline_id)
...
class VariableGroupKeyVaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] search_depth: Set the Azure Key Vault Secret search depth. Defaults to `20`.
        """
        pulumi.set(__self__, "name", name)
...
class VariableGroupVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secret_value: The secret value of the variable. If omitted, it will default to empty string. Used when `is_secret` set to `true`.
        :param pulumi.Input[_builtins.str] value: The value of the variable. If omitted, it will default to empty string.
        """
        pulumi.set(__self__, "name", name)
...
class GetUsersFeaturesArgs:
    ...
    def concurrent_workers(self, value: Optional[_builtins.int]):
