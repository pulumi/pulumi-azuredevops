...
class RepositoryPolicyMaxPathLengthArgs:
    def __init__(__self__, *,
                 max_path_length: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] max_path_length: Block pushes that introduce paths that exceed the specified length.
    ...
    def max_path_length(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def max_path_length(self, value: pulumi.Input[_builtins.int]):
...
class RepositoryPolicyMaxPathLength(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_path_length: Optional[pulumi.Input[_builtins.int]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            repository_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'RepositoryPolicyMaxPathLength':
        """
