...
class ServiceEndpointPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auth_personal is not None and not isinstance(auth_personal, ServiceEndpointPipelineAuthPersonalArgs):
                auth_personal = auth_personal or {}
                def _setter(key, value):
                    auth_personal[key] = value
                ServiceEndpointPipelineAuthPersonalArgs._configure(_setter, **auth_personal)
