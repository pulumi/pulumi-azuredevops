...
class Kubernetes(pulumi.CustomResource):
    ...
    def azure_subscriptions(self) -> Optional[List['outputs.KubernetesAzureSubscription']]:
        """
    ...
    @property
    @pulumi.getter
    def kubeconfigs(self) -> Optional[List['outputs.KubernetesKubeconfig']]:
        """
    ...
    def service_accounts(self) -> Optional[List['outputs.KubernetesServiceAccount']]:
        """
