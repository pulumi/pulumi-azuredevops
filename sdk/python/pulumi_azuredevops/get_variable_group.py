...
def get_variable_group(name: Optional[str] = None,
    ...
    test_project = azuredevops.get_project(name="Test Project")
    test_variable_group = azuredevops.get_variable_group(project_id=test_project.id,
        name="Sample Variable Group")
    pulumi.export("id", test_variable_group.id)
    ```
    ## Relevant Links
