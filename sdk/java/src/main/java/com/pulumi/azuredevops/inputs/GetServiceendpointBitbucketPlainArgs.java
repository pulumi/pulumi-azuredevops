...
public final class GetServiceendpointBitbucketPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceendpointBitbucketPlainArgs Empty = new GetServiceendpointBitbucketPlainArgs();
    ...
    private GetServiceendpointBitbucketPlainArgs() {}

    private GetServiceendpointBitbucketPlainArgs(GetServiceendpointBitbucketPlainArgs $) {
    ...
    public static Builder builder(GetServiceendpointBitbucketPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceendpointBitbucketPlainArgs();
        }

        public Builder(GetServiceendpointBitbucketPlainArgs defaults) {
            $ = new GetServiceendpointBitbucketPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceendpointBitbucketPlainArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetServiceendpointBitbucketPlainArgs", "projectId");
            }
            return $;
        }
    }
