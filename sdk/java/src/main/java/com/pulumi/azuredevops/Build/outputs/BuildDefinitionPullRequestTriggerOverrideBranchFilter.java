...
@CustomType
public final class BuildDefinitionPullRequestTriggerOverrideBranchFilter {
    /**
    ...
    private BuildDefinitionPullRequestTriggerOverrideBranchFilter() {}
    /**
     * @return List of branch patterns to exclude.
     * 
     */
    ...
    public static Builder builder(BuildDefinitionPullRequestTriggerOverrideBranchFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(BuildDefinitionPullRequestTriggerOverrideBranchFilter defaults) {
        ...
        public BuildDefinitionPullRequestTriggerOverrideBranchFilter build() {
            final var _resultValue = new BuildDefinitionPullRequestTriggerOverrideBranchFilter();
