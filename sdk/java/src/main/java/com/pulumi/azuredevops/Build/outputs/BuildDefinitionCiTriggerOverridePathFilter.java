...
@CustomType
public final class BuildDefinitionCiTriggerOverridePathFilter {
    /**
    ...
    public static Builder builder(BuildDefinitionCiTriggerOverridePathFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(BuildDefinitionCiTriggerOverridePathFilter defaults) {
        ...
        public BuildDefinitionCiTriggerOverridePathFilter build() {
            final var _resultValue = new BuildDefinitionCiTriggerOverridePathFilter();
