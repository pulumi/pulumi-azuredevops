...
import com.pulumi.azuredevops.Repository.GitArgs;
import com.pulumi.azuredevops.Repository.inputs.GitState;
import com.pulumi.azuredevops.Repository.outputs.GitInitialization;
...
@ResourceType(type="azuredevops:Repository/git:Git")
public class Git extends com.pulumi.resources.CustomResource {
    ...
    public Git(String name, GitArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Repository/git:Git", name, args == null ? GitArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Git(String name, Output<String> id, @Nullable GitState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Repository/git:Git", name, state, makeResourceOptions(options, id));
    }
