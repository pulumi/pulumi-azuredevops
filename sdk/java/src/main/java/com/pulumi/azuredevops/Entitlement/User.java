...
package com.pulumi.azuredevops.Entitlement;

import com.pulumi.azuredevops.Entitlement.UserArgs;
import com.pulumi.azuredevops.Entitlement.inputs.UserState;
...
@ResourceType(type="azuredevops:Entitlement/user:User")
public class User extends com.pulumi.resources.CustomResource {
    ...
    public User(String name, @Nullable UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Entitlement/user:User", name, args == null ? UserArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private User(String name, Output<String> id, @Nullable UserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Entitlement/user:User", name, state, makeResourceOptions(options, id));
    }
