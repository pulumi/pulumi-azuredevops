...
public class ServiceEndpointKubernetes extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="kubeconfigs", type=List.class, parameters={ServiceEndpointKubernetesKubeconfig.class})
    private Output</* @Nullable */ List<ServiceEndpointKubernetesKubeconfig>> kubeconfigs;

    /**
     * @return A `kubeconfig` block defined blow.
     * 
     */
    public Output<Optional<List<ServiceEndpointKubernetesKubeconfig>>> kubeconfigs() {
