...
public class PipelineAuthorization extends com.pulumi.resources.CustomResource {
    ...
    public Output<Optional<String>> pipelineProjectId() {
        return Codegen.optional(this.pipelineProjectId);
    }
    /**
    ...
    /**
     * @return The type of the resource to authorize. Possible values are: `endpoint`, `queue`, `variablegroup`, `environment`, `repository`. Changing this forces a new resource to be created
     * 
     * &gt; **Note** `repository` is for AzureDevOps repository. To authorize repository other than
     * Azure DevOps like GitHub you need to use service connection(`endpoint`)  to connect and authorize.
     * Typical process for connecting to GitHub:
     ...
     */
    public PipelineAuthorization(java.lang.String name) {
     ...
     */
    public PipelineAuthorization(java.lang.String name, PipelineAuthorizationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PipelineAuthorization(java.lang.String name, PipelineAuthorizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/pipelineAuthorization:PipelineAuthorization", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PipelineAuthorization(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/pipelineAuthorization:PipelineAuthorization", name, state, makeResourceOptions(options, id), false);
    }

    private static PipelineAuthorizationArgs makeArgs(PipelineAuthorizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PipelineAuthorizationArgs.Empty : args;
    }
     ...
     */
    public static PipelineAuthorization get(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
