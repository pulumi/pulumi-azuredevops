...
public final class ServiceendpointJfrogPlatformV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceendpointJfrogPlatformV2Args() {}

    private ServiceendpointJfrogPlatformV2Args(ServiceendpointJfrogPlatformV2Args $) {
    ...
    public static Builder builder(ServiceendpointJfrogPlatformV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceendpointJfrogPlatformV2Args();
        }

        public Builder(ServiceendpointJfrogPlatformV2Args defaults) {
            $ = new ServiceendpointJfrogPlatformV2Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authenticationBasic(@Nullable Output<ServiceendpointJfrogPlatformV2AuthenticationBasicArgs> authenticationBasic) {
         ...
         * 
         */
        public Builder authenticationBasic(ServiceendpointJfrogPlatformV2AuthenticationBasicArgs authenticationBasic) {
         ...
         * 
         */
        public Builder authenticationToken(@Nullable Output<ServiceendpointJfrogPlatformV2AuthenticationTokenArgs> authenticationToken) {
         ...
         * 
         */
        public Builder authenticationToken(ServiceendpointJfrogPlatformV2AuthenticationTokenArgs authenticationToken) {
        ...
        public ServiceendpointJfrogPlatformV2Args build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("ServiceendpointJfrogPlatformV2Args", "projectId");
            }
            if ($.serviceEndpointName == null) {
                throw new MissingRequiredPropertyException("ServiceendpointJfrogPlatformV2Args", "serviceEndpointName");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ServiceendpointJfrogPlatformV2Args", "url");
            }
            return $;
        }
    }
