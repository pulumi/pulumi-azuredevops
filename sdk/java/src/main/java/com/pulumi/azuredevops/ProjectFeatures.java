...
public class ProjectFeatures extends com.pulumi.resources.CustomResource {
     ...
     */
    public ProjectFeatures(java.lang.String name) {
     ...
     */
    public ProjectFeatures(java.lang.String name, ProjectFeaturesArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectFeatures(java.lang.String name, ProjectFeaturesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/projectFeatures:ProjectFeatures", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectFeatures(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectFeaturesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/projectFeatures:ProjectFeatures", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectFeaturesArgs makeArgs(ProjectFeaturesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectFeaturesArgs.Empty : args;
    }
     ...
     */
    public static ProjectFeatures get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectFeaturesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
