...
/**
 * layout: &#34;azuredevops&#34;
 * page_title: &#34;AzureDevops: azuredevops.RepositoryPolicyMaxFileSize&#34;
...
public class RepositoryPolicyMaxFileSize extends com.pulumi.resources.CustomResource {
     ...
     */
    public RepositoryPolicyMaxFileSize(java.lang.String name) {
     ...
     */
    public RepositoryPolicyMaxFileSize(java.lang.String name, RepositoryPolicyMaxFileSizeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RepositoryPolicyMaxFileSize(java.lang.String name, RepositoryPolicyMaxFileSizeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/repositoryPolicyMaxFileSize:RepositoryPolicyMaxFileSize", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RepositoryPolicyMaxFileSize(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryPolicyMaxFileSizeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/repositoryPolicyMaxFileSize:RepositoryPolicyMaxFileSize", name, state, makeResourceOptions(options, id), false);
    }

    private static RepositoryPolicyMaxFileSizeArgs makeArgs(RepositoryPolicyMaxFileSizeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RepositoryPolicyMaxFileSizeArgs.Empty : args;
    }
     ...
     */
    public static RepositoryPolicyMaxFileSize get(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryPolicyMaxFileSizeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
