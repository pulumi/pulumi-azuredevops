...
@CustomType
public final class BuildDefinitionCiTriggerOverrideBranchFilter {
    /**
    ...
    private BuildDefinitionCiTriggerOverrideBranchFilter() {}
    /**
     * @return List of branch patterns to exclude.
     * 
     */
    ...
    public static Builder builder(BuildDefinitionCiTriggerOverrideBranchFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(BuildDefinitionCiTriggerOverrideBranchFilter defaults) {
        ...
        public BuildDefinitionCiTriggerOverrideBranchFilter build() {
            final var _resultValue = new BuildDefinitionCiTriggerOverrideBranchFilter();
