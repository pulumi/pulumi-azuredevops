...
public class BuildFolderPermissions extends com.pulumi.resources.CustomResource {
     ...
     */
    public BuildFolderPermissions(java.lang.String name) {
     ...
     */
    public BuildFolderPermissions(java.lang.String name, BuildFolderPermissionsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BuildFolderPermissions(java.lang.String name, BuildFolderPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/buildFolderPermissions:BuildFolderPermissions", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BuildFolderPermissions(java.lang.String name, Output<java.lang.String> id, @Nullable BuildFolderPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/buildFolderPermissions:BuildFolderPermissions", name, state, makeResourceOptions(options, id), false);
    }

    private static BuildFolderPermissionsArgs makeArgs(BuildFolderPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BuildFolderPermissionsArgs.Empty : args;
    }
     ...
     */
    public static BuildFolderPermissions get(java.lang.String name, Output<java.lang.String> id, @Nullable BuildFolderPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
