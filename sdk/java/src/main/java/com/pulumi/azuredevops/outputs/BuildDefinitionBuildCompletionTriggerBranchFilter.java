...
@CustomType
public final class BuildDefinitionBuildCompletionTriggerBranchFilter {
    /**
    ...
    private BuildDefinitionBuildCompletionTriggerBranchFilter() {}
    /**
     * @return List of branch patterns to exclude.
     * 
     */
    ...
    public static Builder builder(BuildDefinitionBuildCompletionTriggerBranchFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(BuildDefinitionBuildCompletionTriggerBranchFilter defaults) {
        ...
        public BuildDefinitionBuildCompletionTriggerBranchFilter build() {
            final var _resultValue = new BuildDefinitionBuildCompletionTriggerBranchFilter();
