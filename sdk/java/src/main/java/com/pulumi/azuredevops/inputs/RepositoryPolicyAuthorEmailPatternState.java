...
public final class RepositoryPolicyAuthorEmailPatternState extends com.pulumi.resources.ResourceArgs {

    public static final RepositoryPolicyAuthorEmailPatternState Empty = new RepositoryPolicyAuthorEmailPatternState();
    ...
    private @Nullable Output<List<String>> authorEmailPatterns;
    ...
    public Optional<Output<List<String>>> authorEmailPatterns() {
        return Optional.ofNullable(this.authorEmailPatterns);
    }
    ...
    private RepositoryPolicyAuthorEmailPatternState() {}

    private RepositoryPolicyAuthorEmailPatternState(RepositoryPolicyAuthorEmailPatternState $) {
        this.authorEmailPatterns = $.authorEmailPatterns;
    ...
    public static Builder builder(RepositoryPolicyAuthorEmailPatternState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositoryPolicyAuthorEmailPatternState();
        }

        public Builder(RepositoryPolicyAuthorEmailPatternState defaults) {
            $ = new RepositoryPolicyAuthorEmailPatternState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authorEmailPatterns(@Nullable Output<List<String>> authorEmailPatterns) {
         ...
         * 
         */
        public Builder authorEmailPatterns(List<String> authorEmailPatterns) {
            return authorEmailPatterns(Output.of(authorEmailPatterns));
        }
         ...
         * 
         */
        public Builder authorEmailPatterns(String... authorEmailPatterns) {
            return authorEmailPatterns(List.of(authorEmailPatterns));
        }
        ...
        public RepositoryPolicyAuthorEmailPatternState build() {
            return $;
        }
    }
