...
@CustomType
public final class BranchPolicyMergeTypesSettingsScope {
    /**
    ...
    public static Builder builder(BranchPolicyMergeTypesSettingsScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repositoryRef;
        public Builder() {}
        public Builder(BranchPolicyMergeTypesSettingsScope defaults) {
        ...
        public BranchPolicyMergeTypesSettingsScope build() {
            final var _resultValue = new BranchPolicyMergeTypesSettingsScope();
