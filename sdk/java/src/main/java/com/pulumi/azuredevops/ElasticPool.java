...
public class ElasticPool extends com.pulumi.resources.CustomResource {
    ...
    public ElasticPool(java.lang.String name, ElasticPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/elasticPool:ElasticPool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ElasticPool(java.lang.String name, Output<java.lang.String> id, @Nullable ElasticPoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/elasticPool:ElasticPool", name, state, makeResourceOptions(options, id), false);
    }
