...
public class BranchPolicyBuildValidation extends com.pulumi.resources.CustomResource {
     ...
     */
    public BranchPolicyBuildValidation(java.lang.String name) {
     ...
     */
    public BranchPolicyBuildValidation(java.lang.String name, BranchPolicyBuildValidationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BranchPolicyBuildValidation(java.lang.String name, BranchPolicyBuildValidationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/branchPolicyBuildValidation:BranchPolicyBuildValidation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BranchPolicyBuildValidation(java.lang.String name, Output<java.lang.String> id, @Nullable BranchPolicyBuildValidationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/branchPolicyBuildValidation:BranchPolicyBuildValidation", name, state, makeResourceOptions(options, id), false);
    }

    private static BranchPolicyBuildValidationArgs makeArgs(BranchPolicyBuildValidationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BranchPolicyBuildValidationArgs.Empty : args;
    }
     ...
     */
    public static BranchPolicyBuildValidation get(java.lang.String name, Output<java.lang.String> id, @Nullable BranchPolicyBuildValidationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
