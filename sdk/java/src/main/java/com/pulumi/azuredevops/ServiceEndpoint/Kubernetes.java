...
public class Kubernetes extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="azureSubscriptions", type=List.class, parameters={KubernetesAzureSubscription.class})
     ...
     * 
     */
    @Export(name="kubeconfigs", type=List.class, parameters={KubernetesKubeconfig.class})
    private Output</* @Nullable */ List<KubernetesKubeconfig>> kubeconfigs;

    /**
     * @return A `kubeconfig` block defined blow.
     * 
     */
    public Output<Optional<List<KubernetesKubeconfig>>> kubeconfigs() {
        return Codegen.optional(this.kubeconfigs);
    }
    /**
