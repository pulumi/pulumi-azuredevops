...
import com.pulumi.azuredevops.Policy.BranchPolicyMinReviewersArgs;
import com.pulumi.azuredevops.Policy.inputs.BranchPolicyMinReviewersState;
import com.pulumi.azuredevops.Policy.outputs.BranchPolicyMinReviewersSettings;
...
@ResourceType(type="azuredevops:Policy/branchPolicyMinReviewers:BranchPolicyMinReviewers")
public class BranchPolicyMinReviewers extends com.pulumi.resources.CustomResource {
    ...
    public BranchPolicyMinReviewers(String name, BranchPolicyMinReviewersArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Policy/branchPolicyMinReviewers:BranchPolicyMinReviewers", name, args == null ? BranchPolicyMinReviewersArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private BranchPolicyMinReviewers(String name, Output<String> id, @Nullable BranchPolicyMinReviewersState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Policy/branchPolicyMinReviewers:BranchPolicyMinReviewers", name, state, makeResourceOptions(options, id));
    }
