...
public final class CheckRequiredTemplateRequiredTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The type of the repository storing the template. Possible values are: `azuregit`, `github`, `githubenterprise`, `bitbucket`. Defaults to `azuregit`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param repositoryType The type of the repository storing the template. Possible values are: `azuregit`, `github`, `githubenterprise`, `bitbucket`. Defaults to `azuregit`.
         * 
         * @return builder
         * 
         */
