...
public class BranchPolicyCommentResolution extends com.pulumi.resources.CustomResource {
     ...
     */
    public BranchPolicyCommentResolution(java.lang.String name) {
     ...
     */
    public BranchPolicyCommentResolution(java.lang.String name, BranchPolicyCommentResolutionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BranchPolicyCommentResolution(java.lang.String name, BranchPolicyCommentResolutionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/branchPolicyCommentResolution:BranchPolicyCommentResolution", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BranchPolicyCommentResolution(java.lang.String name, Output<java.lang.String> id, @Nullable BranchPolicyCommentResolutionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/branchPolicyCommentResolution:BranchPolicyCommentResolution", name, state, makeResourceOptions(options, id), false);
    }

    private static BranchPolicyCommentResolutionArgs makeArgs(BranchPolicyCommentResolutionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BranchPolicyCommentResolutionArgs.Empty : args;
    }
     ...
     */
    public static BranchPolicyCommentResolution get(java.lang.String name, Output<java.lang.String> id, @Nullable BranchPolicyCommentResolutionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
