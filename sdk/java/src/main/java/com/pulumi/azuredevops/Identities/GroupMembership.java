...
import com.pulumi.azuredevops.Identities.GroupMembershipArgs;
import com.pulumi.azuredevops.Identities.inputs.GroupMembershipState;
...
@ResourceType(type="azuredevops:Identities/groupMembership:GroupMembership")
public class GroupMembership extends com.pulumi.resources.CustomResource {
    ...
    /**
     * A list of user or group descriptors that will become members of the group.NOTE: It&#39;s possible to define group members both within the `azuredevops.GroupMembership resource` via the members block and by using the `azuredevops.Group` resource. However it&#39;s not possible to use both methods to manage group members, since there&#39;ll be conflicts.
     * 
     */
    ...
    /**
     * @return A list of user or group descriptors that will become members of the group.NOTE: It&#39;s possible to define group members both within the `azuredevops.GroupMembership resource` via the members block and by using the `azuredevops.Group` resource. However it&#39;s not possible to use both methods to manage group members, since there&#39;ll be conflicts.
     * 
     */
    ...
    public GroupMembership(String name, GroupMembershipArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Identities/groupMembership:GroupMembership", name, args == null ? GroupMembershipArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private GroupMembership(String name, Output<String> id, @Nullable GroupMembershipState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Identities/groupMembership:GroupMembership", name, state, makeResourceOptions(options, id));
    }
