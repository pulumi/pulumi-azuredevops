...
public final class BranchPolicyMinReviewersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BranchPolicyMinReviewersArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("BranchPolicyMinReviewersArgs", "projectId");
            }
            if ($.settings == null) {
                throw new MissingRequiredPropertyException("BranchPolicyMinReviewersArgs", "settings");
            }
            return $;
        }
    }
