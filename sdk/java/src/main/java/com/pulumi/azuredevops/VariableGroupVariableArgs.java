...
public final class VariableGroupVariableArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public VariableGroupVariableArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("VariableGroupVariableArgs", "projectId");
            }
            if ($.variableGroupId == null) {
                throw new MissingRequiredPropertyException("VariableGroupVariableArgs", "variableGroupId");
            }
            return $;
        }
    }
