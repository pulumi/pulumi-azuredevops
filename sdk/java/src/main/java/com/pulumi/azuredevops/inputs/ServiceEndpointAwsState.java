...
public final class ServiceEndpointAwsState extends com.pulumi.resources.ResourceArgs {

    public static final ServiceEndpointAwsState Empty = new ServiceEndpointAwsState();
    ...
    public static Builder builder(ServiceEndpointAwsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceEndpointAwsState();
        }

        public Builder(ServiceEndpointAwsState defaults) {
            $ = new ServiceEndpointAwsState(Objects.requireNonNull(defaults));
        }
