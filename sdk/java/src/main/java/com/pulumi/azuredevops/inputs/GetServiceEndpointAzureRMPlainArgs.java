...
public final class GetServiceEndpointAzureRMPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceEndpointAzureRMPlainArgs Empty = new GetServiceEndpointAzureRMPlainArgs();
    ...
    private GetServiceEndpointAzureRMPlainArgs() {}

    private GetServiceEndpointAzureRMPlainArgs(GetServiceEndpointAzureRMPlainArgs $) {
    ...
    public static Builder builder(GetServiceEndpointAzureRMPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceEndpointAzureRMPlainArgs();
        }

        public Builder(GetServiceEndpointAzureRMPlainArgs defaults) {
            $ = new GetServiceEndpointAzureRMPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceEndpointAzureRMPlainArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetServiceEndpointAzureRMPlainArgs", "projectId");
            }
            return $;
        }
    }
