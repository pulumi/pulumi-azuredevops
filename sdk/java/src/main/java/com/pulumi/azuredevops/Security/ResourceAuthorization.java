...
package com.pulumi.azuredevops.Security;

import com.pulumi.azuredevops.Security.ResourceAuthorizationArgs;
import com.pulumi.azuredevops.Security.inputs.ResourceAuthorizationState;
...
public class ResourceAuthorization extends com.pulumi.resources.CustomResource {
    ...
    public ResourceAuthorization(String name, ResourceAuthorizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Security/resourceAuthorization:ResourceAuthorization", name, args == null ? ResourceAuthorizationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ResourceAuthorization(String name, Output<String> id, @Nullable ResourceAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Security/resourceAuthorization:ResourceAuthorization", name, state, makeResourceOptions(options, id));
    }
