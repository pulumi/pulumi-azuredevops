...
public class ServiceendpointJenkins extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServiceendpointJenkins(String name) {
     ...
     */
    public ServiceendpointJenkins(String name, ServiceendpointJenkinsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/serviceendpointJenkins:ServiceendpointJenkins", name, args == null ? ServiceendpointJenkinsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceendpointJenkins(String name, Output<String> id, @Nullable ServiceendpointJenkinsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:index/serviceendpointJenkins:ServiceendpointJenkins", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceendpointJenkins get(String name, Output<String> id, @Nullable ServiceendpointJenkinsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
