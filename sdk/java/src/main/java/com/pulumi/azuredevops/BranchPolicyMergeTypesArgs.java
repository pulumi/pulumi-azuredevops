...
public final class BranchPolicyMergeTypesArgs extends com.pulumi.resources.ResourceArgs {

    public static final BranchPolicyMergeTypesArgs Empty = new BranchPolicyMergeTypesArgs();
    ...
    private BranchPolicyMergeTypesArgs() {}

    private BranchPolicyMergeTypesArgs(BranchPolicyMergeTypesArgs $) {
    ...
    public static Builder builder(BranchPolicyMergeTypesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BranchPolicyMergeTypesArgs();
        }

        public Builder(BranchPolicyMergeTypesArgs defaults) {
            $ = new BranchPolicyMergeTypesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder settings(Output<BranchPolicyMergeTypesSettingsArgs> settings) {
            $.settings = settings;
            return this;
        }
        ...
        public BranchPolicyMergeTypesArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("BranchPolicyMergeTypesArgs", "projectId");
            }
            if ($.settings == null) {
                throw new MissingRequiredPropertyException("BranchPolicyMergeTypesArgs", "settings");
            }
            return $;
        }
    }
