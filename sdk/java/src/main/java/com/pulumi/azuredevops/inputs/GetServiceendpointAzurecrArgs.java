...
public final class GetServiceendpointAzurecrArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceendpointAzurecrArgs Empty = new GetServiceendpointAzurecrArgs();
    ...
    private GetServiceendpointAzurecrArgs() {}

    private GetServiceendpointAzurecrArgs(GetServiceendpointAzurecrArgs $) {
    ...
    public static Builder builder(GetServiceendpointAzurecrArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceendpointAzurecrArgs();
        }

        public Builder(GetServiceendpointAzurecrArgs defaults) {
            $ = new GetServiceendpointAzurecrArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceendpointAzurecrArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetServiceendpointAzurecrArgs", "projectId");
            }
            return $;
        }
    }
