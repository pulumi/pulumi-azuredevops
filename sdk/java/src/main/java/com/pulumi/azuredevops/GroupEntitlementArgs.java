...
public final class GroupEntitlementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GroupEntitlementArgs() {}

    private GroupEntitlementArgs(GroupEntitlementArgs $) {
    ...
    public static Builder builder(GroupEntitlementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupEntitlementArgs();
        }

        public Builder(GroupEntitlementArgs defaults) {
            $ = new GroupEntitlementArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param licensingSource The source of the licensing (e.g. Account. MSDN etc.) Valid values: `account` (Default), `auto`, `msdn`, `none`, `profile`, `trial`**NOTE:** A existing group in Azure AD can only be referenced by the combination of `origin_id` and `origin`.
         * 
         * @return builder
         * 
         */
        ...
        public GroupEntitlementArgs build() {
            return $;
        }
    }
