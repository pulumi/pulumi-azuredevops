...
import com.pulumi.azuredevops.Identities.GroupArgs;
import com.pulumi.azuredevops.Identities.inputs.GroupState;
...
@ResourceType(type="azuredevops:Identities/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(String name, @Nullable GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Identities/group:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Group(String name, Output<String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuredevops:Identities/group:Group", name, state, makeResourceOptions(options, id));
    }
