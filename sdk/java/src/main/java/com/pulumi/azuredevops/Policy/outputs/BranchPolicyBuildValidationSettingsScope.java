...
package com.pulumi.azuredevops.Policy.outputs;
...
@CustomType
public final class BranchPolicyBuildValidationSettingsScope {
    /**
    ...
    public static Builder builder(BranchPolicyBuildValidationSettingsScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repositoryRef;
        public Builder() {}
        public Builder(BranchPolicyBuildValidationSettingsScope defaults) {
