...
public final class KubernetesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<KubernetesKubeconfigArgs>> kubeconfigs;

    /**
     * @return A `kubeconfig` block defined blow.
     * 
     */
    public Optional<Output<List<KubernetesKubeconfigArgs>>> kubeconfigs() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder kubeconfigs(@Nullable Output<List<KubernetesKubeconfigArgs>> kubeconfigs) {
         ...
         * 
         */
        public Builder kubeconfigs(List<KubernetesKubeconfigArgs> kubeconfigs) {
         ...
         * 
         */
        public Builder kubeconfigs(KubernetesKubeconfigArgs... kubeconfigs) {
