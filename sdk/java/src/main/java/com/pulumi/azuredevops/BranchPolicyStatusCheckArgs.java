...
public final class BranchPolicyStatusCheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final BranchPolicyStatusCheckArgs Empty = new BranchPolicyStatusCheckArgs();
    ...
    private BranchPolicyStatusCheckArgs() {}

    private BranchPolicyStatusCheckArgs(BranchPolicyStatusCheckArgs $) {
    ...
    public static Builder builder(BranchPolicyStatusCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BranchPolicyStatusCheckArgs();
        }

        public Builder(BranchPolicyStatusCheckArgs defaults) {
            $ = new BranchPolicyStatusCheckArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder settings(Output<BranchPolicyStatusCheckSettingsArgs> settings) {
            $.settings = settings;
            return this;
        }
        ...
        public BranchPolicyStatusCheckArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("BranchPolicyStatusCheckArgs", "projectId");
            }
            if ($.settings == null) {
                throw new MissingRequiredPropertyException("BranchPolicyStatusCheckArgs", "settings");
            }
            return $;
        }
    }
