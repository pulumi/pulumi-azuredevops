...
public final class GetServiceendpointDockerregistryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceendpointDockerregistryPlainArgs Empty = new GetServiceendpointDockerregistryPlainArgs();
    ...
    private GetServiceendpointDockerregistryPlainArgs() {}

    private GetServiceendpointDockerregistryPlainArgs(GetServiceendpointDockerregistryPlainArgs $) {
    ...
    public static Builder builder(GetServiceendpointDockerregistryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceendpointDockerregistryPlainArgs();
        }

        public Builder(GetServiceendpointDockerregistryPlainArgs defaults) {
            $ = new GetServiceendpointDockerregistryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceendpointDockerregistryPlainArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetServiceendpointDockerregistryPlainArgs", "projectId");
            }
            return $;
        }
    }
