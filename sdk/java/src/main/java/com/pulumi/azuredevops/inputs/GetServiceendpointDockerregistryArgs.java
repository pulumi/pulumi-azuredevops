...
public final class GetServiceendpointDockerregistryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceendpointDockerregistryArgs Empty = new GetServiceendpointDockerregistryArgs();
    ...
    private GetServiceendpointDockerregistryArgs() {}

    private GetServiceendpointDockerregistryArgs(GetServiceendpointDockerregistryArgs $) {
    ...
    public static Builder builder(GetServiceendpointDockerregistryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceendpointDockerregistryArgs();
        }

        public Builder(GetServiceendpointDockerregistryArgs defaults) {
            $ = new GetServiceendpointDockerregistryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceendpointDockerregistryArgs build() {
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetServiceendpointDockerregistryArgs", "projectId");
            }
            return $;
        }
    }
