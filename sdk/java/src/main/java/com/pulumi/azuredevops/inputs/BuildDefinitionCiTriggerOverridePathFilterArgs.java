...
public final class BuildDefinitionCiTriggerOverridePathFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BuildDefinitionCiTriggerOverridePathFilterArgs() {}

    private BuildDefinitionCiTriggerOverridePathFilterArgs(BuildDefinitionCiTriggerOverridePathFilterArgs $) {
    ...
    public static Builder builder(BuildDefinitionCiTriggerOverridePathFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BuildDefinitionCiTriggerOverridePathFilterArgs();
        }

        public Builder(BuildDefinitionCiTriggerOverridePathFilterArgs defaults) {
            $ = new BuildDefinitionCiTriggerOverridePathFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BuildDefinitionCiTriggerOverridePathFilterArgs build() {
            return $;
        }
    }
