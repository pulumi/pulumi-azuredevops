...
import com.pulumi.azuredevops.Policy.inputs.BranchPolicyMinReviewersSettingsArgs;
...
public final class BranchPolicyMinReviewersState extends com.pulumi.resources.ResourceArgs {

    public static final BranchPolicyMinReviewersState Empty = new BranchPolicyMinReviewersState();
    ...
    private BranchPolicyMinReviewersState() {}

    private BranchPolicyMinReviewersState(BranchPolicyMinReviewersState $) {
    ...
    public static Builder builder(BranchPolicyMinReviewersState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BranchPolicyMinReviewersState();
        }

        public Builder(BranchPolicyMinReviewersState defaults) {
            $ = new BranchPolicyMinReviewersState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder settings(@Nullable Output<BranchPolicyMinReviewersSettingsArgs> settings) {
            $.settings = settings;
            return this;
        }
        ...
        public BranchPolicyMinReviewersState build() {
            return $;
        }
    }
