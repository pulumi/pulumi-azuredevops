...
@CustomType
public final class BranchPolicyAutoReviewersSettingsScope {
    /**
    ...
    private BranchPolicyAutoReviewersSettingsScope() {}
    /**
     * @return The match type to use when applying the policy. Supported values are `Exact` (default), `Prefix` or `DefaultBranch`.
     * 
     */
    ...
    public static Builder builder(BranchPolicyAutoReviewersSettingsScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repositoryRef;
        public Builder() {}
        public Builder(BranchPolicyAutoReviewersSettingsScope defaults) {
        ...
        public BranchPolicyAutoReviewersSettingsScope build() {
            final var _resultValue = new BranchPolicyAutoReviewersSettingsScope();
